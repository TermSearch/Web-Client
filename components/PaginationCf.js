...
const {PaginationBuilder} = require('cf-builder-pagination');
...
class Component extends React.Component {
  ...
  maybeRequestPage(page) {
    ...
    const [start,
      end] = getStartAndEnd(page, this.state.perPage);
  ...
  render() {
    ...
    return (<PaginationBuilder onPageChange={this.handlePageChange} totalCount={this.state.totalCount} page={this.state.page} perPage={this.state.perPage}/>);
  }
}
